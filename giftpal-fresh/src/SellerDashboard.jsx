    ...
    <div style={{ background: '#181312', minHeight: '100vh', color: 'white' }}>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{
          ...
          {['overview', 'products', 'orders', 'analytics', 'marketing'].map(tab => (
            <button
              key={tab}
        ...
        {activeTab === 'marketing' && (
          <div>
            <h2 style={{ fontSize: '1.8rem', marginBottom: '2rem' }}>Marketing & Growth</h2>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  <h3 style={{ color: '#4ecdc4', fontSize: '1.3rem', fontWeight: 600 }}>
                    Sponsored Ads
                  </h3>
                </div>
                <p style={{ color: '#b8a89c', marginBottom: '1.5rem', lineHeight: 1.6 }}>
                  Promote your products with targeted advertising. Reach more customers and boost sales with our advanced ad platform.
                </p>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                  ...
                  <h3 style={{ color: '#ff6347', fontSize: '1.3rem', fontWeight: 600 }}>
                    SEO Optimization
                  </h3>
                </div>
                <p style={{ color: '#b8a89c', marginBottom: '1.5rem', lineHeight: 1.6 }}>
                  Improve your store's search visibility. Optimize product titles, descriptions, and keywords to rank higher.
                </p>
                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ color: '#b8a89c', fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                    SEO Score: <span style={{ color: '#ff6347', fontWeight: 600 }}>78/100</span>
                  </div>
                  <div style={{ color: '#b8a89c', fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                    Optimized Products: <span style={{ color: '#ff6347', fontWeight: 600 }}>12/20</span>
                  </div>
                  <div style={{ color: '#b8a89c', fontSize: '0.9rem' }}>
                    Keywords Tracked: <span style={{ color: '#ff6347', fontWeight: 600 }}>15</span>
                  </div>
                </div>
                <Link
                  to="/seo-optimization"
            ...
            <div style={{
              ...
              <h3 style={{ color: '#ffd700', fontSize: '1.3rem', fontWeight: 600, marginBottom: '1.5rem' }}>
                💡 Marketing Tips
              </h3>
              <div style={{ display: 'grid', gap: '1rem' }}>
                <div style={{
                  ...
                  <h4 style={{ color: '#4ecdc4', marginBottom: '0.5rem' }}>Optimize Product Images</h4>
                  <p style={{ color: '#b8a89c', fontSize: '0.9rem' }}>
                    High-quality images increase conversion rates by up to 40%. Use multiple angles and lifestyle shots.
                  </p>
                </div>
                <div style={{
                  background: '#0f0f0f',
                  ...
                  <h4 style={{ color: '#ff6347', marginBottom: '0.5rem' }}>Write Compelling Descriptions</h4>
                  <p style={{ color: '#b8a89c', fontSize: '0.9rem' }}>
                    Focus on benefits, not just features. Use emotional language and include relevant keywords.
                  </p>
                </div>
                <div style={{
                  background: '#0f0f0f',
                  ...
                  <h4 style={{ color: '#ffd700', marginBottom: '0.5rem' }}>Encourage Customer Reviews</h4>
                  <p style={{ color: '#b8a89c', fontSize: '0.9rem' }}>
                    Products with reviews sell 270% more than those without. Follow up with customers post-purchase.
                  </p>
                </div>
              </div>
            </div>
