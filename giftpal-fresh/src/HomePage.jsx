...
import { GiftDiscoverySection } from './components/ui/section-mockup-demo'
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <Link to="/section-mockup-demo" style={{
              display: 'flex',
              alignItems: 'center',
              gap: '0.8rem',
              color: theme.textSecondary,
            ...
            onMouseLeave={(e) => {
              ...
              <span>🎨</span> Component Demo
              <span style={{ marginLeft: 'auto', fontSize: '0.8rem', color: '#9333ea' }}>NEW</span>
            </Link>
            <Link to="/brands" style={{
              display: 'flex',
              alignItems: 'center',
